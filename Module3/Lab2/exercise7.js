...
function getTitles(authorInitial) {
    return books.filter(book => book.author[0].toLowerCase() === authorInitial.toLowerCase()).map(book => book.title);
}   
console.log(getTitles('f')); // ['The Great Gatsby']
console.log(getTitles('h')); // ['To Kill a Mockingbird']
console.log(getTitles('g')); // ['1984', 'Brave New World']
console.log(getTitles('a')); // ['The Catcher in the Rye']
...
console.log(latestBook()); // { id: 2, title: 'To Kill a Mockingbird', author: 'Harper Lee', year
